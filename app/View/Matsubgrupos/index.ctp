...
<div class="matsubgrupo index"  align="center">
			...
			<span><h2>Manutenção de Cadastros</h2></span>
 				<table cellspacing="2" cellpadding="2" style="border: 2px solid #ddd;"><tr><td width="15px"></td><td>
                    ...
                    <table cellspacing="2" cellpadding="2" width="100%">
 						<tr>
							<td colspan="2"><p class="text-left"><h3>&nbsp;&nbsp;<?php echo __('Sub-grupos de Materiais'); ?></h3></p></td>
						</tr>
						<tr>
							<td><?php echo $this->Form->create('matsubgrupo', array('action' => 'index')); ?>
								Buscar Sub-grupos&nbsp;<input type="text" name="tx_nome" id="tx_nome" size="25">&nbsp;
								<input type="submit" value="Buscar" class="btn btn-default">
								<?php echo $this->Form->end() ?>
							</td>

 							<td><p class="text-right">&nbsp;&nbsp;<?php echo $this->Html->link('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>'.__('Novo Grupo'), array('action' => 'add'), array('escape' => false)); ?> </p></td>
 						</tr>
                        ...
                        <tr><td colspan="2">
							...
							<tbody>
							<?php foreach ($data as $matsubgrupo) { ?>
							<tr>
								<td align="center" nowrap><?php echo h($matsubgrupo['matsubgrupo']['id_subgrupo']); ?>&nbsp;</td>
								<td nowrap><?php echo h($matsubgrupo['matsubgrupo']['tx_descricao']); ?>&nbsp;</td>
									<?php if (h($matsubgrupo['matsubgrupo']['tp_status']) == 'A') {
								...
								<td class="actions" align="center">
									...
									<?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', array('action' => '../matsubgrupos/edit', $matsubgrupo['matsubgrupo']['id_subgrupo']), array('escape' => false)); ?>
	                            &nbsp;&nbsp;<?php echo $this->Form->postLink('<p class="glyphicon glyphicon-minus" aria-hidden="true"></p>', array('action' => 'delete', $matsubgrupo['matsubgrupo']['id_subgrupo']), array('escape' => false), __('Você deseja realmente deletar o Gênero: %s?', $matsubgrupo['matsubgrupo']['id_subgrupo'])); ?>
								</td>
							</tr>
							<?php } ?>
							</tbody>
