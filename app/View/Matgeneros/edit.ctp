...
<div class="matgeneros form">
	...
	<div class="container">
		...
		<div class="row" align="center">
			...
			<div class="col-md-9">
				<?php echo $this->Form->create('matgenero', array('action' => 'edit')); ?>
                        ...
                        <tr><td colspan="2">
	                    	<table style="border: 2px solid #ddd;">
								<tr>
	                    			...
	                    			<?php 
	                    				$options = array('' => 'Selecione uma situação','0' => 'Ativo', '1' => 'Inativo');
									 	...
									 	echo $this->Form->input('id_genero', array('class' => 'form-control', 'label' => 'Código', 'placeholder' => 'Código'));
	                    			?>
	                    			</div></td>
	                    			<td width="15px"></td>
								</tr>
								...
								<tr>
									...
									<td align="center">&nbsp;
										<?php echo $this->Form->postLink('<input type="button" value="Excluir" class="btn btn-default">&nbsp;&nbsp;', array('action' => 'delete', $this->Form->value('matgeneros.id_genero')), array('escape' => false), __('Você realmente deseja excluir definitivamente o Gênero?', $this->Form->value('Matgenero.'))); ?>
									</td>
									<td align="center">
										<input type="button" value="Cancelar" onclick="javascript:window.location = '../../Matgeneros';" class="btn btn-default">
									</td>
									<td width="15px"></td>
								</tr>
								<tr><td width="15px"></td><td colspan="3">&nbsp;</td><td width="15px"></td></tr>
