...
<div class="usuarios index"  align="center">
			...
			<span><h2>Manutenção de Cadastros</h2></span>
 				<table cellspacing="2" cellpadding="2" style="border: 2px solid #ddd;"><tr><td width="15px"></td><td>
                    ...
                    <table cellspacing="2" cellpadding="2" width="100%">
						...
						<tr>
							<td><?php echo $this->Form->create('usuario', array('action' => 'index')); ?>
								Buscar Cliente&nbsp;<input type="text" name="tx_nome" id="tx_nome" size="25">&nbsp;
								<input type="submit" value="Buscar" class="btn btn-default">
								<?php echo $this->Form->end() ?>
							</td>

 							<td><p class="text-right">&nbsp;&nbsp;<?php echo $this->Html->link('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>'.__('Novo Usuário'), array('action' => 'add'), array('escape' => false)); ?> </p></td>
 						</tr>
                        ...
                        <tr><td colspan="2">
							...
							<tr>
								<td align="center" nowrap><?php echo h($usuario['usuario']['id']); ?>&nbsp;</td>
								<td nowrap><?php echo h($usuario['usuario']['nome']); ?>&nbsp;</td>
								<td nowrap><?php echo h($usuario['usuario']['email']); ?>&nbsp;</td>
								<td nowrap><?php echo h($usuario['usuario']['nivel']); ?>&nbsp;</td>	
								<td class="actions" align="center">
									...
									<?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', array('action' => 'edit', $usuario['usuario']['id']), array('escape' => false)); ?>
	                            &nbsp;&nbsp;<?php echo $this->Form->postLink('<p class="glyphicon glyphicon-minus" aria-hidden="true"></p>', array('action' => 'delete', $usuario['usuario']['id']), array('escape' => false), __('Você deseja realmente deletar o Usuário: %s?', $usuario['usuario']['id'])); ?>
								</td>
							</tr>
							<?php } ?>
							</tbody>
