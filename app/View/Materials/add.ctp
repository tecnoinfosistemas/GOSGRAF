...
<div class="materials form" align="center">
			...
			<span><h2 >Manutenção de Cadastros</h2></span>
 				<table cellspacing="2" cellpadding="2" style="border: 2px solid #ddd;" ><tr><td width="15px"></td><td  align="center">
                    ...
                    <table cellspacing="2" cellpadding="2" width="100%">
                        ...
                        <tr><td colspan="2">
                        	<?php echo $this->Form->create('material',array('action' => 'add')); ?>
	                    	...
	                    	<table style="border: 2px solid #ddd;">
								...
								<tr>
									...
									<td><div class="form-group"><?php echo $this->Form->input('dt_ultima_compra', array('class' => 'form-control datepicker', 'label' => 'Data da última compra (AAAA-MM-DD)', 'type' => 'text', 'format' => 'Y-m-d', 'default' => date('Y-m-d'), 'value' => !empty($item->date) ? $item->date->format('Y-m-d') : date('Y-m-d')));?></div></td>
	                    			<td width="15px"></td>
								</tr>
								<tr>
									<td width="15px"></td>
								...
								<tr>
									...
									?>
									<td width="15px"></td>
									<td colspan="3"><div class="form-group"><?php echo $this->Form->input('dt_inclui', array('class' => 'form-control', 'type' => 'hidden', 'value' => $date));?></div></td>
									<td width="15px"></td>
								</tr>
								<tr>
									<td width="15px"></td>
								...
								<tr>
									<td width="15px"></td>
									<td colspan="3" align="center"><input type="submit" value="Salvar" class="btn btn-default">&nbsp;&nbsp;<input type="button" value="Cancelar" onclick="javascript:window.location = '../Materials';" class="btn btn-default"></td>
									<td width="15px"></td>
								</tr>
