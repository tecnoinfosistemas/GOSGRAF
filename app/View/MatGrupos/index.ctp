...
<div class="matgrupo index"  align="center">
			...
			<span><h2>Manutenção de Cadastros</h2></span>
 				<table cellspacing="2" cellpadding="2" style="border: 2px solid #ddd;"><tr><td width="15px"></td><td>
                    ...
                    <table cellspacing="2" cellpadding="2" width="100%">
						...
						<tr>
							<td><?php echo $this->Form->create('Matgrupo', array('action' => 'index')); ?>
								Buscar Grupos&nbsp;<input type="text" name="tx_nome" id="tx_nome" size="25">&nbsp;
                        ...
                        <tr><td colspan="2">
							...
							<tbody>
							<?php foreach ($data as $matgrupo) { ?>
							<tr>
								<td align="center" nowrap><?php echo h($matgrupo['matgrupo']['id_grupo']); ?>&nbsp;</td>
								<td nowrap><?php echo h($matgrupo['matgrupo']['tx_descricao']); ?>&nbsp;</td>
									<?php if (h($matgrupo['matgrupo']['tp_status']) == 'A') {
								...
								<td class="actions" align="center">
									...
									<?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', array('action' => '../Matgrupos/edit', $matgrupo['matgrupo']['id_grupo']), array('escape' => false)); ?>
	                            &nbsp;&nbsp;<?php echo $this->Form->postLink('<p class="glyphicon glyphicon-minus" aria-hidden="true"></p>', array('action' => 'delete', $matgrupo['matgrupo']['id_grupo']), array('escape' => false), __('Você deseja realmente deletar o Gênero: %s?', $matgrupo['matgrupo']['id_grupo'])); ?>
								</td>
							</tr>
							<?php } ?>
							</tbody>
