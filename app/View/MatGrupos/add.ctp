...
<div class="matgrupos form" align="center">
			...
			<span><h2 >Manutenção de Cadastros</h2></span>
 				<table cellspacing="2" cellpadding="2" style="border: 2px solid #ddd;" ><tr><td width="15px"></td><td  align="center">
                    ...
                    <table cellspacing="2" cellpadding="2" width="100%">
                        ...
                        <tr><td colspan="2">
                        	<?php echo $this->Form->create('matgrupo',array('action' => 'add')); ?>
	                    	...
	                    	<table style="border: 2px solid #ddd;">
	                    		<tr>
	                    			...
	                    			<?php 
	                    				$options = array('' => 'Selecione uma situação','0' => 'Ativo', '1' => 'Inativo');
									 	...
									 	echo $this->Form->input('id_grupo', array('class' => 'form-control', 'label' => 'Código', 'type' => 'hidden', 'placeholder' => 'Código'));
	                    			?>
	                    			</div></td>
	                    			<td width="15px"></td>
								</tr>
								...
								<tr>
									<td width="15px"></td>
									<td colspan="3" align="center"><input type="submit" value="Salvar" class="btn btn-default">&nbsp;&nbsp;<input type="button" value="Cancelar" onclick="javascript:window.location = '../matgrupos';" class="btn btn-default"></td>
									<td width="15px"></td>
								</tr>
								<tr><td width="15px"></td><td colspan="3">&nbsp;</td><td width="15px"></td></tr>
