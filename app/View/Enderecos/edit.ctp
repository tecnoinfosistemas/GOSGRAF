...
<div class="endereco form">
	...
	<div class="container">
		...
		<div class="row">
			...
			$caminho_end3 = "../Enderecos/edit?tipo=".$tabela_inf."&tab=".$tabela_inf."&cod=".$codigo;
			echo $caminho_end3;
			?>
			<?php
				//echo $this->Form->create('endereco', array('action' => $caminho_end3));
				echo $this->Form->create('endereco', array('url'=>array('controller'=>'Enderecos','action' => 'edit',$this->paramans['pass'][0])));
			?>
				<span><h2 >Manutenção de Cadastros Edição</h2></span>
										...
										<table style="border: 2px solid #ddd;">
											...
											<tr>
												...
												<td width="300px"><div class="form-group">
														<?php echo $this->Form->input('id_pessoa', array('class' => 'form-control', 'type' => 'hidden', 'placeholder' => 'Código','value' => h($endereco['endereco']['id_pessoa'])));?>
														<?php echo $this->Form->input('id_tabela', array('class' => 'form-control', 'type' => 'hidden', 'placeholder' => 'Código','value' => h($endereco['endereco']['id_tabela'])));?>
														<?php echo $this->Form->input('tx_endereco', array('class' => 'form-control', 'label' => 'Endereço','value' => h($endereco['endereco']['tx_endereco'])));?></div></td>
												...
												<td width="250px"><div class="form-group"><?php echo $this->Form->input('tx_complem_end', array('class' => 'form-control', 'label' => 'Complemento','value' => h($endereco['endereco']['tx_complem_end'])));?></div></td>
												<td width="15px">&nbsp;</td>
											</tr>
											<tr>
												<td></td>
