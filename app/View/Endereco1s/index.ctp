...
<div class="endereco1s index"  align="center">
			...
			<span><h2>Manutenção de Cadastros</h2></span>
 				<table cellspacing="2" cellpadding="2" style="border: 2px solid #ddd;"><tr><td width="15px"></td><td>
                    ...
                    <table cellspacing="2" cellpadding="2" width="100%">
 						<tr>
							<td colspan="2"><p class="text-left"><h3>&nbsp;&nbsp;<?php echo __('Endereços Clientes'); ?></h3></p></td>
						</tr>
						<tr>
							<td><?php echo $this->Form->create('endereco1', array('action' => 'index')); ?>
								Buscar Fornecedor&nbsp;<input type="text" name="tx_nome" id="tx_nome" size="25">&nbsp;
								<input type="submit" value="Buscar" class="btn btn-default">
								<?php echo $this->Form->end() ?>
							</td>

 							<td><p class="text-right">&nbsp;&nbsp;<?php echo $this->Html->link('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>'.__('Novo Endereço Cliente'), array('action' => 'add'), array('escape' => false)); ?> </p></td>
 						</tr>
                        ...
                        <tr><td colspan="2">
							...
							<tbody>
							<?php foreach ($data as $endereco1) { ?>
							<tr>
								<td align="center" nowrap><?php echo h($endereco1['endereco1']['id_pessoa']); ?>&nbsp;</td>
								<td nowrap><?php echo h($endereco1['endereco1']['tx_endereco']); ?>&nbsp;</td>
								<td nowrap><?php echo h($endereco1['endereco1']['tx_cidade']); ?>&nbsp;</td>	
								<td nowrap><?php echo h($endereco1['endereco1']['tx_uf']); ?>&nbsp;</td>
								<td nowrap><?php echo h($endereco1['endereco1']['tx_pais']); ?>&nbsp;</td>
								<td class="actions" align="center">
									...
									<?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', array('action' => 'edit', $endereco1['endereco1']['id_pessoa']), array('escape' => false)); ?>
	                            &nbsp;&nbsp;<?php echo $this->Form->postLink('<p class="glyphicon glyphicon-minus" aria-hidden="true"></p>', array('action' => 'delete', $endereco1['endereco1']['id_pessoa']), array('escape' => false), __('Você deseja realmente deletar o endereço do cliente: %s?', $endereco1['endereco1']['id_pessoa'])); ?>
								</td>
							</tr>
							<?php } ?>
							</tbody>
