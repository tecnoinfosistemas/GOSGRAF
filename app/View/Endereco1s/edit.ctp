...
<div class="endereco1s form">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
				<?php echo $this->Form->create('endereco1', array('action' => 'edit')); ?>
				...
				<table cellspacing="2" cellpadding="2" style="border: 2px solid #ddd;" ><tr><td width="15px"></td><td  align="center">
							<?php
							$numero = $this->Form->value('endereco1.id_pessoa');
										...
										<table>
											<tr>
												<td style="border-top: 2px solid #ddd;border-left: 2px solid #ddd;border-right: 2px solid #ddd;width: 120px; text-align: center;"><h4><b>
													<?php echo $this->Html->link('Cliente', array('action' => '../Clientes/edit', $numero), array('escape' => false)); ?>
												</b></h4></td>
										...
										<table style="border: 2px solid #ddd;">
											...
											<tr>
												...
												<td width="300px"><div class="form-group">
														<?php echo $this->Form->input('id_pessoa', array('class' => 'form-control', 'type' => 'hidden', 'placeholder' => 'Código'));?>
											...
											<tr>
												...
												<td colspan="2" align="center"><?php echo $this->Form->postLink('<input type="button" value="Excluir" class="btn btn-default">&nbsp;&nbsp;', array('action' => 'delete', $this->Form->value('endereco1.id_pessoa')), array('escape' => false), __('Você realmente deseja excluir definitivamente esse endereço?', $this->Form->value('endereco1.'))); ?></td>
